...
const definedLessons: CourseLesson[] = [
  ...
  { number: 6, slug: "06-model-prompt-messages", title: "模型、Prompt 与 Messages", shortTitle: "模型与消息", description: "分清模型与编排器的职责。", status: "open", duration: "9 分钟" },
  { number: 7, slug: "07-connect-model-api", title: "安全连接第一个模型 API", shortTitle: "连接模型 API", description: "在服务端安全完成真实调用。", status: "open", duration: "8 分钟" },
  { number: 8, slug: "08-agent-api-and-deploy", title: "建立 /api/agent 并部署到 Vercel", shortTitle: "Agent API", description: "让网页连接 Python LangGraph。", status: "open", duration: "9 分钟" },
  { number: 9, slug: "09-streaming", title: "Streaming：让用户看见 Agent 正在做什么", shortTitle: "流式事件", description: "逐步显示 token、节点和工具事件。", status: "open", duration: "9 分钟" },
  { number: 10, slug: "10-quota-and-cost", title: "调用限额、成本与第一个在线 Agent", shortTitle: "限额与成本", description: "保护 API 预算和在线服务。", status: "open", duration: "9 分钟" },
  { number: 11, slug: "11-router-and-structured-output", title: "Router 与结构化输出", shortTitle: "Router", description: "让请求进入可验证的正确分支。", status: "open", duration: "8 分钟" },
  { number: 12, slug: "12-state-schema", title: "State Schema：给状态定合同", shortTitle: "State Schema", description: "明确输入、输出与字段边界。", status: "open", duration: "8 分钟" },
  { number: 13, slug: "13-reducers-and-merging", title: "Reducer：并行更新怎样合并", shortTitle: "Reducer", description: "比较覆盖、追加和自定义合并。", status: "open", duration: "8 分钟" },
  { number: 14, slug: "14-context-management", title: "消息太长怎么办", shortTitle: "上下文管理", description: "裁剪、过滤和总结消息。", status: "open", duration: "9 分钟" },
  { number: 15, slug: "15-persistent-sessions", title: "持久化会话项目", shortTitle: "持久化会话", description: "进程重启后恢复并切换 thread。", status: "open", duration: "8 分钟" },
  { number: 16, slug: "16-approval-policy", title: "审批策略：什么动作必须问人", shortTitle: "审批策略", description: "按风险分配自动、审批与禁止。", status: "open", duration: "8 分钟" },
  { number: 17, slug: "17-edit-state-and-feedback", title: "人工修改 State 与反馈", shortTitle: "编辑 State", description: "修改参数后从 checkpoint 继续。", status: "open", duration: "8 分钟" },
  { number: 18, slug: "18-time-travel", title: "Time Travel：回到旧状态再走一遍", shortTitle: "Time Travel", description: "回放旧状态并分叉新结果。", status: "open", duration: "8 分钟" },
  { number: 19, slug: "19-retry-and-idempotency", title: "Retry、错误节点与幂等性", shortTitle: "错误恢复", description: "安全重试有副作用的步骤。", status: "open", duration: "9 分钟" },
  { number: 20, slug: "20-trusted-agent-project", title: "项目：可信文件整理 Agent", shortTitle: "可信 Agent 项目", description: "验收批准、拒绝和失败恢复。", status: "open", duration: "10 分钟" },
  { number: 21, slug: "21-parallelization", title: "Parallelization：能同时做的不要排队", shortTitle: "并行分支", description: "比较串行和并行时间线。", status: "open", duration: "8 分钟" },
  { number: 22, slug: "22-map-reduce", title: "Map-reduce：批量处理再汇总", shortTitle: "Map-reduce", description: "扇出处理多份材料再汇聚。", status: "open", duration: "8 分钟" },
