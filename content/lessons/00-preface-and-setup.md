...
> **术语说明**
>
> - **LangGraph**：组织执行顺序、保存运行现场，并支持暂停和恢复。
> - **Node（节点）**：完成流程中的一小步工作。
> - **Edge（边）**：规定完成当前节点后去哪里。
> - **State（运行状态）**：保存流程中的消息和共享数据。
